  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12">
      <section className="bg-white p-8 rounded-lg shadow-lg text-gray-800">
        <h1 className="text-3xl sm:text-2xl sm:text-xl font-bold text-center mb-6 text-blue-700">Đơn vị tổ chức</h1>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            <div className="text-center sm:text-left">
                <h2 className="text-2xl sm:text-xl font-bold">Trường Đại học ABC</h2>
      ...
      <section className="bg-white p-8 rounded-lg shadow-lg text-gray-800">
        <h1 className="text-3xl sm:text-2xl sm:text-xl font-bold text-center mb-8 text-blue-700">Đơn vị tài trợ & Đối tác</h1>
