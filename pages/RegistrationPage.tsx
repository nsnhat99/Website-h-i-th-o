...
const RegistrationPage: React.FC = () => {
  ...
  if (isSubmitted) {
    return (
        <div className="max-w-2xl mx-auto text-center bg-white p-10 rounded-lg shadow-lg">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-3">Đăng ký thành công!</h2>
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
      <h1 className="text-3xl font-bold text-center mb-2 text-gray-800">Đăng ký tham dự</h1>
